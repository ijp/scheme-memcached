...
(define-test-case memcached-tests mc:incr/decr!
  ...
  (test-eqv 20 (memcached-incr! (current-connection) (s "foo") 10))
  (test-eqv 0 (memcached-decr! (current-connection) (s "bar") 5))
  (test-eqv 20 (memcached-incr! (current-connection) (s "foo") 10 20))
  (test-eqv 0 (memcached-decr! (current-connection) (s "bar") 5 20))
  (test-eqv 20 (memcached-incr! (current-connection) (s "baz") 10 20))
  (test-eqv 20 (memcached-decr! (current-connection) (s "baz") 10 20)))
